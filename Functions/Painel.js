...
async function Painel(interaction, client) {
  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      { name: `**Versão do AS**`, value: `\`Indefinido\``, inline: true },
    ...
    .setTimestamp()
    .setImage("https://media.discordapp.net/attachments/1304515208043298847/1313723534031192135/Painel_Alien.jpg?ex=67512be2&is=674fda62&hm=d44c6db7153d2009543ed994c0b75b42ab934da09d38121dd29bf86764c4056c&=&format=webp"); // Adicionando a imagem
